...
The [markov-chain-monte-carlo][mcmc-lib] scientific computing library community is founded on the [UC Davis Principles of Community][uc-davis-principles], adapted for our collaborative open-source scientific computing environment. We are committed to fostering an inclusive community that advances robust, reproducible Monte Carlo simulation and research software.
...
- **High-quality code**: Writing well-documented, tested, and maintainable implementations of sampling algorithms and diagnostics
- **Rigorous validation**: Ensuring Metropolis-Hastings mechanics, proposal contracts, and numerical checks are mathematically sound and computationally robust
- **Knowledge sharing**: Providing clear documentation, examples, and educational resources about Markov Chain Monte Carlo methods
...
Our work builds upon decades of Monte Carlo, statistical physics, and computational statistics research. We:
...
- Contribute back to the scientific computing and open-source communities
...
- **Technical discussions** about algorithmic approaches, numerical robustness, performance optimization, and API design
- **Questions** from newcomers to MCMC, scientific computing, or Rust programming
...
- Patient explanation of statistical and numerical concepts
...
- Being patient with those learning MCMC and Rust concepts
