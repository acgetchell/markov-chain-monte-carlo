...
> Treat the rows below as immutable legacy observations, not reproducible release evidence. This archived report preserves the historical record and must
> not be updated, regenerated, or promoted.
