...
- Sampler::new now returns Result&lt;Self, McmcError&gt;, Sampler::chain_mut has been removed, and serde resumes should deserialize ChainCheckpoint and restore
  with Chain::from_checkpoint instead of deserializing Chain directly.

### Merged Pull Requests

- Validate sampler construction and checkpoint restores [#46](https://github.com/acgetchell/markov-chain-monte-carlo/pull/46)
